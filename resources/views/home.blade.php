...
<body class="bg-[#EEE1D1] m-0 p-0 hide-scroll-y overflow-y-scroll">
    ...
    <section class="mb-80">
        <h2 class="text-6xl font-bold text-center text-[#163A35] mt-80">Apa yang dikatakan <br>Pelanggan Kami</h2>
        <img src="{{ asset('images/profile-cr.png') }}" alt="" class="mt-28 mx-auto h-20">
        <div class=" bg-[#2A635C] px-12 py-12 mx-52 mt-12 rounded-[6rem] rounded-bl-none">
            ...
            <div class="flex justify-between mb-6 mt-16">
                <div class="flex ms-24">
                    <h5 class="text-white text-2xl font-medium">Axelia Salim</h5>
                    <div class="w-3 h-0.5 bg-white mt-5 ms-2"></div>
                    <p class="text-white text-xl mt-1 ms-2 font-light">Loyal Costumer</p>
                </div>
    ...
    <footer>
        ...
        <div class="min-w-full bg-[#2A635C] pb-20">
            <div class="flex justify-between content-center">
                <h3 class="text-white font-bold text-7xl ms-28"><i>Selamat Menikmati <br>Menu
                        Kami</i></h3>
                <button type="button"
                    class="text-white text-lg bg-[#E8512A] font-medium px-12 py- text-center me-28 my-10 rounded-tl-xl rounded-br-xl">
                    Pesan Sekarang</button>
            </div>
            <div id="line" class="bg-white min-w-screen h-1 ms-28 mt-28"></div>
            <div>
                {{-- <div class="flex justify-evenly ms-28 my-28">
                    <h5 class="text-white text-3xl font-medium mt-6">RM. Ratu Boga</h5>
                    <img src="{{ asset('images/logo-white.png') }}" alt="" class="w-16">
                </div> --}}
            </div>
        </div>
    </footer>
