...
@section('content')
    <section>
        ...
        <svg id="wave" class="-mt-10 rotate-180" viewBox="0 0 1440 220" version="1.1"
    ...
    <section class="mb-80">
        <h2 class="text-6xl font-bold text-center text-junggleGreen mt-80">Kami menyajikan menu yang <br>cocok dengan
            lidah anda</h2>
        <div class="mx-56 my-28 flex justify-between">
            <div class="max-w-xs rounded-lg shadow bg-flame">
                <a href="#">
    ...
    <section class="mb-80">
        ...
        <div class=" bg-slateGreen px-12 py-12 mx-48 mt-28 rounded-[6rem] rounded-bl-none">
            ...
            <h5 class="text-white text-4xl ms-24 me-8 font-light -mt-12">Menu dari RM. Ratu
    ...
    <section>
        ...
        <div class="min-w-full bg-slateGreen pb-6">
