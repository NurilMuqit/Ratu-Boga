<footer class="bg-slateGreen pt-16 pb-10 min-w-full">
    <div class="flex flex-col mx-28">
        <div class="footer-container flex justify-between">
            <div class="flex flex-col">
                <div>
                    <div class="flex items-center">
                        <h5 class="font-PlayfairDisplay text-3xl font-bold text-white">RM. Ratu Boga</h5>
                        <img src="{{ asset('images/logo-white.png') }}" alt="" class="h-12 ms-5">
                    </div>
