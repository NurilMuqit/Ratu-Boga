    ...
    <div class="w-full grid grid-cols-2 p-8">
        <div class=" text-junggleGreen pr-8 space-y-1">
            <div class="grid update_menu grid-cols-1 space-y-1">
                <label class="text-sm font-bold  tracking-wide">Update menu name</label>
            ...
            <div class="update_desc grid  grid-cols-1 space-y-1">
                <label class="text-sm font-bold  tracking-wide">Update desc menu</label>
                <textarea class="text-sm p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-flame" type="text"
                    name="menu_description" placeholder="Write Menu desc">{{ $menu->menu_description }}</textarea>

            </div>

            <div class="update_quantity grid  grid-cols-1 space-y-1">
                <label class="text-sm font-bold  tracking-wide">Update quantity menu
                </label>
                <input class="text-sm p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-flame"
                    type="number" name="menu_quantity" min="0" placeholder="Write Menu quantity"
                    value="{{ $menu->menu_quantity }}">

            </div>

            <div class="update_price grid grid-cols-1 space-y-1">
                <label class="text-sm font-bold  tracking-wide">Update price menu</label>
                <input class="text-sm p-3 border border-gray-300 rounded-lg focus:outline-none focus:border-flame"
                    type="number" name="menu_price" placeholder="Write Menu price" min="0" required=""
                    value="{{ $menu->menu_price }}">
            </div>
            <div class="update_category grid grid-cols-1 add_category space-y-2">
                <label class="text-sm font-bold  tracking-wide">Update category menu
                </label>
        ...
        <div class="w-full rounded-xl " style="height: 28rem  ">
            <div class="rounded-xl group border-2 border-junggleGreen image_past w-full h-full relative">
                <img id="menuImage" class="rounded-xl border-solid border-flame w-full h-full object-cover"
                    src="/menu/{{ $menu->image }}" alt="">
                <div
                    ...
                    <p class="absolute bottom-0 w-full text-center left-0 opacity-50 mb-3 text-xs">File type: jpg, png,
                        jpeg types of
                        images | max: 2048</p>
                </div>
